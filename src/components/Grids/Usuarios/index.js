               ...
               <Text style={{ color: '#595858', fontSize: 14, marginTop:10, alignContent:"center", textAlign:"center" }}>Nenhum Registro Encontrado!</Text>
                ...
                <View>
                     <SwipeableRow
                        ...
                        onPressDelete={async () => {
                            excluir(data.nome, data.telefone);
                        }}
                    ...
                    >                   
                        ...
                        >     
                            ...
                            <Text style={{ color: '#000', fontSize:12 }}>{data.email} - cpf: {data.cpf}</Text>
                                </View>
                            </View>
...
<Modal 
      ...
      >
         ...
         <Text style={styles.Cliente}>{data.nome} - {data.telefone}</Text>
                ...
                <View style={styles.Section}>
                    ...
                    <Text style={styles.Entrada}>Cpf: {data.cpf}</Text>
